                        ...
                        <div class="card-body">
                            <div class="row align-items-center justify-content-between">
                                                    ...
                                                    <div class="btn-group" role="group">
                                                      <button id="btnGroupDrop1" type="button" class="btn btn-white dropdown-toggle dropdown-toggle-nocaret px-1" data-bs-toggle="dropdown" aria-expanded="false">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                            ...
                                                            @endphp
                                                            <li><a class="dropdown-item" style="text-align: right;" href="{{ route('subscriber.all.building') }}">الكل</a></li>
                                                            @foreach ($categories as $item)
                                                            <li><a class="dropdown-item" style="text-align: right;" href="{{ route('subscriber.all.sort',$item->id) }}">{{ $item->category_name }}</a></li>
                                                            @endforeach
                                            ...
                                            <div class="col-12">
                                                <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                                    ...
                                                    <div class="btn-group" role="group">
                                                      ...
                                                      <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                        <li><a class="dropdown-item" style="text-align: right;" href="{{ route('subscriber.all.building') }}">الكل</a></li>
                                                        <li><a class="dropdown-item"  style="text-align: right;" href="{{ route('subscriber.sort.rent') }}">إيجار</a></li>
                                                        <li><a class="dropdown-item"  style="text-align: right;" href="{{ route('subscriber.sort.buy') }}">بيع</a></li>
                                                      </ul>
                                                    </div>
                                                  </div>
                                            </div>
                                ...
                                <div class="col-lg-3 col-xl-2">
                                    <a href="{{ route('subscriber.add.building') }}" class="btn btn-primary mb-3 mb-lg-0 building-add-button">إضافه عقار</a>
                                </div>
                            </div>
                        </div>
                    </div>
