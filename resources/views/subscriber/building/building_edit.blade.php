        ...
        <div class="card-body">
            <table class="table mb-0 table-striped">
                ...
                <tbody>
                    ...
                    <form method="post" action="{{ route('subscriber.update.building.multiimage') }}" enctype="multipart/form-data">
                        @csrf
                        @foreach($multiImgs as $key => $img)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('subscriber.building.multiimg.delete',$img->id) }}" class="btn btn-danger" id="delete">حذف</a>
                                </td>
                            </tr>
                        @endforeach
                    </form>
        ...
        <div class="card-body">
            <table class="table mb-0 table-striped">
                ...
                <tbody>
                    ...
                    <form method="post" action="{{ route('subscriber.update.building.multivideo') }}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <tr>
                                    ...
                                    <td>
                                        <input type="submit" class="btn btn-primary px-4" value="تحديث" />
                                        <a href="{{ route('subscriber.building.multivideo.delete',$video->id) }}" class="btn btn-danger" id="delete">حذف</a>
                                    </td>
                                </tr>
                            @endforeach
                    </form>
