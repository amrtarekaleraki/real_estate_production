     ...
     <div class="container">
        ...
        <div class="all-files">
            ...
            <div class="row p-3">
                ...
                <form method="POST" action="{{ route('subscriber.profile.store') }}" enctype="multipart/form-data">
                    @csrf

                <div class="row p-3">
                    <div class="col-lg-2 profile-settings-img">
                        <label for="file-input" class="profile-settings-img-parent">
                            <img id="preview-image" src="{{ (!empty($SubscriberData->photo)) ? url('upload/subscriber_images/'.$SubscriberData->photo)  : url('upload/no_image.jpg') }}" alt="Profile Image">
                    ...
                    <div class="row p-3">
                        ...
                        <div class="col-lg-6 add-buildings-inputs">
                             ...
                             <input name="name" type="text" placeholder=" الاسم" value="{{ $SubscriberData->name }}">
                        </div>

                        <div class="col-lg-6 add-buildings-inputs">
                            <label for="">البريد الالكتروني</label>
                            <input name="email" type="text" placeholder="البريد" value="{{ $SubscriberData->email }}" disabled>
                       </div>

                        <div class="col-lg-6 add-buildings-inputs">
                        <label for="">رقم الهاتف</label>
                        <input name="phone" type="text" placeholder="الهاتف" value="{{ $SubscriberData->phone }}">
                        </div>
