            ...
            <div class="row p-3">
                ...
                <div class="col-lg-12">
                    <div class="all-files-title">
                        <h2>إضافه مستأجر او مالك</h2>
                    </div>
                </div>

                <form id="myForm" method="POST" action="{{ route('admin.store.owner') }}" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="row p-3">
                    ...
                    <div class="row p-3">
                        ...
                        <div class="form-group col-lg-6 add-buildings-inputs">
                            ...
                            <input name="address" type="text" class="form-control" placeholder="العنوان" value="">
                       </div>
