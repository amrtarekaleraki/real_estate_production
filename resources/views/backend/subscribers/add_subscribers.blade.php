     ...
     <div class="container">
        ...
        <div class="all-files">
            ...
            <div class="row p-3">
                ...
                <form id="myForm" method="POST" action="{{ route('admin.store.subscriber') }}" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="row p-3">
                    ...
                    <div class="row p-3">
                        ...
                        <div class="form-group col-lg-6 add-buildings-inputs">
                             ...
                             <input name="name" type="text" class="form-control"  placeholder=" الاسم" value="">
                        </div>

                        <div class="form-group col-lg-6 add-buildings-inputs">
                            <label for="">البريد الالكتروني</label>
                            <input name="email" type="text" class="form-control" placeholder="البريد" value="">
                       </div>

                        <div class="col-lg-6 add-buildings-inputs">
                        <label for="">رقم الهاتف</label>
                        <input name="phone" type="text" placeholder="الهاتف" value="">
                        </div>
                        ...
                        <div class="form-group col-lg-6 add-buildings-inputs">
                            ...
                            <label style="width: 100%;">
                              <input name="subscribe_time" class="form-control" type="date" id="myDateInput"  style="width: 100%;"   placeholder="اضغط للاختيار" >
                            </label>
                        </div>
