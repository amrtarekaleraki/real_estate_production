$(function () {
    ...
    var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
            labels: ['2022', 'Tu', 'We', 'Th', 'Fr', 'Sa', 'Su'],
            datasets: [{
                label: 'Google',
                data: [13, 8, 20, 4, 18, 29, 25],
                barPercentage: .5,
                backgroundColor: "#0d6efd",
                hoverRadius: 0, // Disable hover effect on this dataset
                hoverBackgroundColor: "#0d6efd" // Keep original background color when hovering (optional)
            }, {
                label: 'Facebook',
                ...
                hoverRadius: 0, // Disable hover effect on this dataset
                hoverBackgroundColor: "#f41127" // Keep original background color when hovering (optional)
            }]
        },
        options: {
            maintainAspectRatio: false,
